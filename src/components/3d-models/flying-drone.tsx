...
const modelPath = "/assets/3d-models/flying-drone/scene.gltf"


export const FlyingDrone = (props: GroupProps) => {
  const group = useRef()
  ...
  useEffect(() => {
    if (actions) {
      const action = actions['hover']; // Make sure to use the exact name here
      if (action) {
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Sketchfab_Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]} scale={11.07}>
          <group name="root">
